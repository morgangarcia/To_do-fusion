...
function (_Component) {
  ...
  _proto.render = function render() {
    return React__default.createElement(StyletronContext.Provider, {
      value: this.props.value
    }, React__default.createElement(DebugEngineContext.Provider, {
      value: this.props.debug
    }, React__default.createElement(HydrationContext.Provider, {
...
function DevConsumer(props) {
  return React__default.createElement(StyletronContext.Consumer, null, function (styletronEngine) {
    return React__default.createElement(DebugEngineContext.Consumer, null, function (debugEngine) {
      return React__default.createElement(HydrationContext.Consumer, null, function (hydrating) {
...
function createStyledElementComponent(_ref2) {
  ...
  function StyledElement(props) {
    return React__default.createElement(Consumer, null, function (styletron, debugEngine, hydrating) {
...
exports.toMergeReducer = toMergeReducer;
