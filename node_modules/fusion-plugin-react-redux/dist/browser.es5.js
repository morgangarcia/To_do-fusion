...
var ctxEnhancer = (function (ctx) {
  return function (createStore) {
    return function () {
      var store = _objectSpread({}, createStore.apply(void 0, arguments), {
        ctx: ctx
      });
 ...
 * 
 */
var ReduxToken = fusionCore.createToken('ReduxToken');
var ReducerToken = fusionCore.createToken('ReducerToken');
var PreloadedStateToken = fusionCore.createToken('PreloadedStateToken');
var EnhancerToken = fusionCore.createToken('EnhancerToken');
var GetInitialStateToken = fusionCore.createToken('GetInitialStateToken');
...
var getPlugin = function getPlugin() {
  ...
  return fusionCore.createPlugin({
      ...
      var Redux = function Redux(ctx) {
        if (storeCache) {
          ...
          if (!preloadedState) {
            ...
            if (stateElement) {
              preloadedState = JSON.parse(fusionCore.unescape(stateElement.textContent));
            }
          }
          ...
          redux.compose.apply(void 0, enhancers));
    ...
    middleware: function middleware(_, redux$$1) {
      return function (ctx, next) {
        var _redux$from = redux$$1.from(ctx),
